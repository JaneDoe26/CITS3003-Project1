...
float distTerm = 1/(3 + 0.5*magOfLvec+ 0.5*magOfLvec*magOfLvec); 

float magOfLvec2 = length(Lvec2);

float distTerm2 = 1/(3 + 0.5*magOfLvec+ 0.5*magOfLvec*magOfLvec); 
    ...
    vec3  specular = Ks * SpecularProduct*(10.0, 10.0, 10.0) + distTerm; 
