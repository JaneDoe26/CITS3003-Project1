...
//--------------------------------------------------------------------------------------------------------------------------------
    ...
    vec3  specular2 = Ks2 * SpecularProduct*(20.0,20.0,20.0);
    ...
    gl_FragColor = vec4(globalAmbient  + ambient+ambient2 + diffuse+diffuse2 + specular+specular2, 1.0)*texture2D( texture, texCoord * 2.0);
    gl_FragColor.a = 1.0;
}
